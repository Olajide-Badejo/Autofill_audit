...
than being left blank. A transformer rung was specified as an optional later
phase and has not been built. A blank cell in a comparison table reads as a
measurement of zero, which would be a fabricated number in the one place a
reader trusts most.
